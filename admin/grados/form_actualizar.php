...
if (isset($_SESSION['rol']) and $_SESSION['rol'] == 1) {
    if (isset($_REQUEST['actualizar'])) {
        ...
        $Actualizar = $conexion->query("SELECT * FROM `grados` WHERE grados.Id_Grado=$documento");
        ...
        <div class="container text-center card card-body">
            ...
            <form action="registrar.php" method="REQUEST">
                <div class="form_group">
                    ...
                    <input class="text-center" type="number" name="identificacion" value="<?php echo $row['Id_Grado']; ?>" class="from_control" readonly>
                </div>
                <div class="form_group">
